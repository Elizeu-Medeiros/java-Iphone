...
O diagrama UML que representa a estrutura do projeto pode ser encontrado na pasta `UML` com o nome Iphone.drawio.
...
Siga essas instruções para garantir que seu projeto seja bem documentado no GitHub, facilitando
